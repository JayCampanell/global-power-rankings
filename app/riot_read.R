...
final_rank <- read_csv("balanced ranks.csv", col_types = 'c') 
...
allGames <- read_rds("All Games.rds")
...
tournament_rankings <- read_csv("tournament_ranking_final.csv", col_types = cols(.default = "c"))
